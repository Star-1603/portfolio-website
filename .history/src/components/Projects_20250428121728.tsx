...
const Projects: React.FC = () => {
  ...
  const projects = [
    ...
    {
      title: "Uplift",
      description: "Uplift is an AI-powered mental healthcare chatbot designed to support emotional well-being. It uses sentiment analysis and intelligent conversation to detect early signs of distress, provide coping strategies, mindfulness exercises, and recommend professional resources when needed. Built with empathy at its core, Uplift helps users navigate their mental health journey one conversation at a time.",
